...
public class ControleExcecoes extends ResponseEntityExceptionHandler {
	...
	@Override
	@ExceptionHandler({ Exception.class, RuntimeException.class, Throwable.class }) /*Intercepta e pega os erros dessas classes de excessão em Java.*/
	...
	protected ResponseEntity<Object> handleExceptionDataIntegry(Exception ex) {
		...
		objetoError.setError(msg);
		objetoError.setCode(
				HttpStatus.INTERNAL_SERVER_ERROR + " ==> " + HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase()); /*Geralmente sempre erro interno do servidor*/
