...
public class MenuController {
	...
	public ResponseEntity<Page<Menu>> menu() throws InterruptedException {
		...
		// depois cria um método para isso e chame onde quiser, poe xemplo, pode colocar no user service
		//aí em qualquer lugar do código você consegue recuperar o usurio logado. ok tadeu. 
		// Vou tentar fazer isso, obrigado pela ajuda. De nada, agora está fácil finalizar! :)
